return {
	...
	tglb=
	{
		[1]=
		{
			...
			price = 19900,
			name = "金猪礼包",
			desc = "5元×40次红包任务 10张千元赛门票 1张万元赛门票 18万鲸币 30天记牌器",
			icon = "hall_btn_gift4",
			order = 2,
			on_off = 1,
			not_buy_show = 1,
			...
			gotoUI = {"free_hall",},
			get_end_tips = "您当日奖励已领取，请明日6点再来(可在我的收益中查看奖金)",
		...
		[6]=
		{
			...
			not_buy_show = 1,
			title = "成功参与一次千元大奖赛",
			award = " 奖励：<color=#ED8813FF><size=26>10</size></color>红包券",
			remain = "剩余领取次数:%s/%s",
		...
		[7]=
		{
			...
			award = "奖励：<color=#ED8813FF><size=26>5</size></color>红包券",
			remain = "剩余领取次数:%s/%s",
