return {
	config=
	{
		...
		{
			id = 413,
			key = "sys_act_base_style/sys_act_base_043_weekly",
			desc = "狂欢庆典",
			is_on_off = 1,
			enable = 1,
			state = 1,
		...
		{
			id = 416,
			key = "act_ty_by_drop_style/act_036_youcaihua",
			desc = "蛋糕鱼BOSS",
			is_on_off = 1,
			enable = 1,
			state = 1,
		...
		{
			id = 428,
			key = "act_ty_gifts_style/act_042_jflb",
			desc = "庆典礼包",
			is_on_off = 1,
			enable = 1,
			state = 1,
		...
		{
			id = 433,
			key = "act_ty_exchange_style/act_031_hldh",
			desc = "好礼兑换",
			is_on_off = 1,
			enable = 1,
			state = 1,
		...
		{
			id = 434,
			key = "act_ty_rank_style/act_045_tqbd",
			desc = "招财榜单",
			is_on_off = 1,
			enable = 1,
			state = 1,
