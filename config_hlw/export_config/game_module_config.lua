return {
	config=
	{
		...
		{
			id = 320,
			key = "sys_act_base_style/sys_act_base_026_weekly",
			desc = "扩展活动皮肤",
			is_on_off = 1,
			enable = 1,
			state = 1,
		...
		{
			id = 334,
			key = "act_ty_gifts_style/act_012_qdlb",
			desc = "积分礼包",
			is_on_off = 1,
			enable = 1,
			state = 1,
		...
		{
			id = 344,
			key = "act_ty_rank_style/act_012_qdbd",
			desc = "真爱榜单",
			is_on_off = 1,
			enable = 1,
			state = 1,
		...
		{
			id = 359,
			key = "act_hlw2hlby_guide",
			desc = "闲玩、PC蛋蛋向欢乐天天捕鱼引导",
			lua = "Act_HLW2HLBYManager",
			is_on_off = 1,
			enable = 1,
			state = 1,
		},
