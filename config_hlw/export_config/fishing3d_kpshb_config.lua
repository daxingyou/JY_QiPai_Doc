return {
	config=
	{
		[1]=
		{
			...
			game_id = 2,
			hb = {0.1,0.3,1},
			jd = {50000,110000,180000 ,},
			show_hb = 3,
			hb_show = "0.01;0.05;0.1#0.08;0.1;0.3#0.24;0.3;0.5;1",
			key = "actp_own_task_p_ljyjcfk_hlw",
			asset_value = {0.01,0.05,0.1,0.8,0.1,0.3,0.24,0.3,0.5,1},
		...
		[2]=
		{
			...
			game_id = 3,
			hb = {5,15,60},
			jd = {3000000,9600000,27400000,},
			show_hb = 6,
			hb_show = "1;3;5#5;10;15#30;40;50;60",
			key = "actp_own_task_p_ljyjcfk_hlw",
			asset_value = {1,3,5,5,10,15,30,40,50,60},
			asset_type = {"shop_gold_sum","shop_gold_sum","shop_gold_sum","shop_gold_sum","shop_gold_sum","shop_gold_sum","shop_gold_sum","shop_gold_sum","shop_gold_sum"},
		},
	},
	jjconfig=
