return {
	config=
	{
		...
		{
			id = 413,
			key = "sys_act_base_style/sys_act_base_010_weekly",
			desc = "欢乐嘉年华",
			is_on_off = 1,
			enable = 1,
			state = 1,
		...
		{
			id = 416,
			key = "act_ty_by_drop_style/act_010_juhua",
			desc = "菊花BOSS",
			is_on_off = 1,
			enable = 1,
			state = 1,
		...
		{
			id = 428,
			key = "act_ty_gifts_style/act_011_qflb",
			desc = "祈福礼包",
			is_on_off = 1,
			enable = 1,
			state = 1,
		...
		{
			id = 433,
			key = "act_ty_exchange_style/act_005_hldh",
			desc = "好礼兑换",
			is_on_off = 1,
			enable = 1,
			state = 1,
		...
		{
			id = 434,
			key = "act_ty_rank_style/act_011_jfbd",
			desc = "积分榜单",
			is_on_off = 1,
			enable = 1,
			state = 1,
